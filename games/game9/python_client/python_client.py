...
from addicted_voronoi import VORONOI_STUFF
...
class Client:
    def __init__(self, host, port, name):
        ...
        self.voronoi_stuff = VORONOI_STUFF(self.num_players, self.num_stone, self.player_number)
    ...
    def __getMove(self):
        move = self.voronoi_stuff.get_move()
        self.voronoi_stuff.log_move((move.x, move.y, 0))
    ...
    def start(self):
        for p in range(self.num_players):
            while True:
                ...
                assert num_new_moves == self.num_players - 1 or num_new_moves == 0, "num_new_moves: " + str(num_new_moves) + "; num_players: " + str(self.num_players)
                ...
                for i in range(num_new_moves):
                    ...
                    if player > 0:
                        ...
                        self.voronoi_stuff.log_move((move_row, move_col, 1))
                    else:
